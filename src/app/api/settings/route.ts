  ...
  try {
    ...
    const [updated] = await db
      ...
      .set({
        ...
        openrouterKey: typeof body.openrouterKey === "string" && body.openrouterKey ? body.openrouterKey.slice(0, 200) : undefined,
        openrouterModel: typeof body.openrouterModel === "string" && body.openrouterModel ? body.openrouterModel.slice(0, 100) : undefined,
        updatedAt: new Date(),
      })
